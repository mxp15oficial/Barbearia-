...
// Garante que ambas as abas (ENTRAR e CADASTRAR) estejam visíveis ao carregar a página
...
document.getElementById('formCadastro').addEventListener('submit', (e) => {
  ...
  // Verifica se o número já está cadastrado no sistema
  const usuarioExistente = localStorage.getItem(`user_${tel}`);
  if (usuarioExistente) {
    alert("⚠️ Este número de celular já possui uma conta cadastrada! Faça login na aba 'ENTRAR'.");
    return;
  }
